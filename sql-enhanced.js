...
Draw.loadPlugin(function(ui) {
    ...
    // Extends Extras menu
    mxResources.parse('robSql=From Rob');

    var wnd = new mxWindow(mxResources.get('robSql'), div, document.body.offsetWidth - 480, 140,
        320, 300, true, true);
...
*/
    ...
    // Adds action
    ui.actions.addAction('robSql', function() {
    ...
    theMenu.funct = function(menu, parent) {
        ...
        ui.menus.addMenuItems(menu, ['robSql'], parent);
    };
});